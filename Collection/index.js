...
function () {
  ...
  _proto.create = function create(recordBuilder = _noop.default) {
    return new Promise(function ($return, $error) {
      ...
      return Promise.resolve(this.database.batch(record)).then(function ($await_1) {
        try {
  ...
  _proto.unsafeFetchRecordsWithSQL = function unsafeFetchRecordsWithSQL(sql) {
    return new Promise(function ($return, $error) {
      ...
      (0, _invariant.default)(typeof adapter.unsafeSqlQuery === 'function', 'unsafeFetchRecordsWithSQL called on database that does not support SQL');

...
function schemaMigrations(migrationSpec) {
  ...
  if (process.env.NODE_ENV !== 'production') {
    ...
    migrations.forEach(function (migration) {
      ...
      (0, _common.invariant)(typeof toVersion === 'number', 'Invalid migration - `toVersion` must be a number');
      (0, _common.invariant)(toVersion >= 2, "Invalid migration to version ".concat(toVersion, ". Minimum possible migration version is 2"));

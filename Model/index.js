...
function () {
  ...
  _proto.update = function update(recordUpdater = _noop.default) {
    return new Promise(function ($return, $error) {
      ...
      return Promise.resolve(this.collection.database.batch(this)).then(function ($await_1) {
        try {
          return $return();
        } catch ($boundEx) {
  ...
  _proto.markAsDeleted = function markAsDeleted() {
    return new Promise(function ($return, $error) {
      ...
      return Promise.resolve(this.collection.database.batch(this.prepareMarkAsDeleted())).then(function ($await_2) {
        try {
          return $return();
        } catch ($boundEx) {
          return $error($boundEx);
  ...
  _proto.destroyPermanently = function destroyPermanently() {
    return new Promise(function ($return, $error) {
      ...
      return Promise.resolve(this.collection.database.batch(this.prepareDestroyPermanently())).then(function ($await_3) {
        try {
          return $return();
        } catch ($boundEx) {
          return $error($boundEx);
    ...
    return new Promise(function ($return, $error) {
      ...
      return Promise.resolve((0, _helpers2.fetchChildren)(this)).then(function ($await_4) {
        try {
          ...
          return Promise.resolve((_this$collection$data = this.collection.database).batch.apply(_this$collection$data, _toConsumableArray(children).concat([this.prepareMarkAsDeleted()]))).then(function ($await_5) {
            try {
              return $return();
            } catch ($boundEx) {
              return $error($boundEx);
    ...
    return new Promise(function ($return, $error) {
      ...
      return Promise.resolve((0, _helpers2.fetchChildren)(this)).then(function ($await_6) {
        try {
          ...
          return Promise.resolve((_this$collection$data2 = this.collection.database).batch.apply(_this$collection$data2, _toConsumableArray(children).concat([this.prepareDestroyPermanently()]))).then(function ($await_7) {
            try {
              return $return();
            } catch ($boundEx) {
              return $error($boundEx);
  ...
  _proto._setRaw = function _setRaw(rawFieldName, rawValue) {
    ...
    (0, _invariant.default)(!this._getChanges().isStopped && this._raw._status !== 'deleted', 'Not allowed to change deleted records');

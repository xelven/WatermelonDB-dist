...
var recordStatesEqual = function recordStatesEqual(left, right) {
...
function subscribeToQueryWithColumns(query, columnNames, subscriber) {
  ...
  var collectionUnsubscribe = query.collection.experimentalSubscribe(function observeWithColumnsCollectionChanged(changeSet) {

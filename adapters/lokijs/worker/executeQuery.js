...
function refineResultsForColumnComparisons(roughResults, conditions) {
  if ((0, _QueryDescription.hasColumnComparisons)(conditions)) {
    ...
    var matcher = (0, _encodeMatcher.default)(queryWithoutJoins);
...
function executeQuery(query, loki) {
  ...
  (0, _invariant.default)(!query.description.sortBy.length, '[WatermelonDB][Loki] Q.sortBy() not yet supported');
  (0, _invariant.default)(!query.description.take, '[WatermelonDB][Loki] Q.take() not yet supported');

...
var encodeComparison = function encodeComparison({
  operator: operator,
  right: right
}) {
...
var encodeWhereDescription = function encodeWhereDescription({
  left: left,
...
var encodeJoin = function encodeJoin([table, associationInfo], conditions) {
  return {
    table: table,

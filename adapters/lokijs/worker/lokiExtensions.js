...
var isIDBAvailable = function isIDBAvailable(onQuotaExceededError) {
  return new Promise(function (resolve) {
    ...
    checkRequest.onerror = function (event) {
      ...
      var error = event === null || event === void 0 ? void 0 : (_event$target = event.target) === null || _event$target === void 0 ? void 0 : _event$target.error; // this is what Firefox in Private Mode returns:

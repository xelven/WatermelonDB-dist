...
function () {
  ...
  _proto.setUp = function setUp() {
    return new Promise(function ($return, $error) {
      return Promise.resolve(this._openDatabase()).then(function ($await_6) {
        try {
          return Promise.resolve(this._migrateIfNeeded()).then(function ($await_7) {
            try {
              return $return();
            } catch ($boundEx) {
  ...
  _proto.batch = function batch(operations) {
    ...
    Object.entries(recordsToCreate).forEach(function (args) {
      var [table, raws] = args;
      var shouldRebuildIndexAfterIndex = raws.length >= 1000; // only profitable for large inserts
  ...
  _proto.unsafeResetDatabase = function unsafeResetDatabase() {
    return new Promise(function ($return, $error) {
      return Promise.resolve((0, _lokiExtensions.deleteDatabase)(this.loki)).then(function ($await_8) {
        try {
          this.cachedRecords.clear();

          _common.logger.log('[WatermelonDB][Loki] Database is now reset');

          return Promise.resolve(this._openDatabase()).then(function ($await_9) {
            try {
              this._setUpSchema();
    ...
    return new Promise(function ($return, $error) {
      ...
      if (dbVersion === schemaVersion) {// All good!
        ...
        if (dbVersion === 0) {
          ...
          return Promise.resolve(this.unsafeResetDatabase()).then(function ($await_11) {
            try {
          ...
          if (dbVersion > 0 && dbVersion < schemaVersion) {
            ...
            if (migrationSteps) {
              ...
              try {
                return Promise.resolve(this._migrate(migrationSteps)).then(function ($await_12) {
                  try {
                    return $Try_1_Post();
                  } catch ($boundEx) {
              ...
              return Promise.resolve(this.unsafeResetDatabase()).then(function ($await_13) {
                try {
                  return $If_5.call(this);
                } catch ($boundEx) {
                  return $error($boundEx);
            ...
            return Promise.resolve(this.unsafeResetDatabase()).then(function ($await_14) {
              try {
                return $If_4.call(this);
              } catch ($boundEx) {
                return $error($boundEx);
